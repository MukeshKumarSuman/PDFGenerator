...
public class PDFTextWriter {
    ...
    public PDFTextWriter(PDDocument document, PDPageContentStream contentStream) {
    ...
    void addSingleLineText(String text, int xPosition, int yPosition, PDFont font, float fontSize, Color color) throws IOException {
        ...
        contentStream.newLineAtOffset(xPosition, yPosition); // SET CONTENT POSITION ON PAGE
